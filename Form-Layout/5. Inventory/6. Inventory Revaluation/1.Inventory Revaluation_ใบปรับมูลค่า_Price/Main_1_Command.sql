...
MRV1.UnitMsr,
MRV2.Quantity,
MRV2.LineTotal As DeCre,
MRV1.WhsCode,
ISNULL(MRV2.INMOpenQty,MRV1.ROnHand) AS 'INMOpenQty',
ISNULL(MRV2.RActPrice,MRV1.RActPrice) As 'RActPrice',
ISNULL(MRV2.Price,MRV1.Price) As 'Price',
CASE
