...
SELECT DISTINCT
    CASE 
        ...
        ELSE OCPR.Cellolar
    END AS 'Phone2_Format', -- เปลี่ยนชื่อเพื่อไม่ให้ซ้ำกับ Phone2 ด้านล่าง
...
-- ใช้ OUTER APPLY ดึง Project ขึ้นมาแค่ตัวเดียวป้องกันข้อมูลเบิ้ล
OUTER APPLY (
...
-- เช็คว่าเป็น Draft (112) ของ Sales Order (ObjType = 17)
