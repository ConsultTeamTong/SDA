...
-- ===== แก้ตรงนี้: ใช้ subquery แทน pj JOIN =====
...
-- ❌ ลบบรรทัดนี้ทิ้ง:
-- LEFT JOIN QUT1 pj ON OQUT.DocEntry = QUT1.DocEntry AND pj.Project IS NOT NULL AND pj.Project <> ''
...
-- ❌ ลบบรรทัดนี้ทิ้ง (เพราะ pj ไม่มีแล้ว):
