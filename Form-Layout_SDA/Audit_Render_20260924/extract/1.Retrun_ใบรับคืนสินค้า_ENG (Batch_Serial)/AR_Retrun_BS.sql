...
-- RPT: 2. Sales - AR\4. Return\2.Retrun_ใบรับคืนสินค้า_(Batch_Serial)\1.Retrun_ใบรับคืนสินค้า_ENG (Batch_Serial).rpt
-- SCOPE: main
-- ALIAS: AR_Retrun_BS
-- FIELDS: 42
-- ---------------------------------------------------------------
...
ISNULL(NULLIF(OUOM.U_SLD_Uomforeign,''), RDN1.UomCode) AS UgpCode
,
...
LEFT JOIN OUOM ON RDN1.UomCode = OUOM.UomCode
