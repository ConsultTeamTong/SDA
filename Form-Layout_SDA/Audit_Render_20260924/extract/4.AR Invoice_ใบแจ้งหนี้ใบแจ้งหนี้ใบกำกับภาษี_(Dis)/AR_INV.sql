-- ============================================================
-- Report: 4.AR Invoice_ใบแจ้งหนี้ใบแจ้งหนี้ใบกำกับภาษี_(Dis).rpt
-- Path:   4.AR Invoice_ใบแจ้งหนี้ใบแจ้งหนี้ใบกำกับภาษี_(Dis).rpt
-- Extracted: 2026-09-24 10:20:57
-- Source: Main Report
-- Table:  AR_INV
-- ============================================================

-- RPT: 2. Sales - AR\6. AR Invoice\2.AR Invoice_ใบแจ้งหนี้_(Dis)\1.AR Invoice_ใบแจ้งหนี้_(Dis).rpt
-- SCOPE: main
-- ALIAS: AR_INV
-- FIELDS: 50
-- ---------------------------------------------------------------
