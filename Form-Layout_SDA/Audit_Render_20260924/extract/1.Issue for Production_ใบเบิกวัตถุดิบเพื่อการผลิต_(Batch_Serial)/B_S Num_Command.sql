...
WHERE PV.BaseType = 60) As rRow ) As Serial ON OIGE.DocEntry = Serial.BaseEntry AND IGE1.LineNum = Serial.BaseLinNum AND IGE1.ItemCode = Serial.ItemCode
-------------------------------------------------------BATCH---------------------------------------------------------------------------------------
LEFT JOIN (SELECT *,
...
WHERE PVB.BaseType = 60) As BATCH ) As Batch_N ON OIGE.DocEntry = Batch_N.BaseEntry AND IGE1.LineNum = Batch_N.BaseLinNum AND IGE1.ItemCode = Batch_N.ItemCode
