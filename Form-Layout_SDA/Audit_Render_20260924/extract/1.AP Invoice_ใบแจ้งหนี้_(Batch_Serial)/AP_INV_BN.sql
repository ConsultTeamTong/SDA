...
-- Extracted: 2026-09-24 10:19:54
-- Source: Main Report
-- Table:  AP_INV_BN
-- ============================================================

-- RPT: 3. Purchasing - AP\7. AP Invoice\2.AP Invoice_ใบแจ้งหนี้_(Batch_Serial)\1.AP Invoice_ใบแจ้งหนี้_(Batch_Serial).rpt
-- SCOPE: main
-- ALIAS: AP_INV_BN
-- FIELDS: 55
-- ---------------------------------------------------------------
...
LEFT JOIN CRD1 ON OCRD.CardCode = CRD1.CardCode AND CRD1.AdresType = 'B' AND CRD1.[Address] = OPCH.PayToCode 
