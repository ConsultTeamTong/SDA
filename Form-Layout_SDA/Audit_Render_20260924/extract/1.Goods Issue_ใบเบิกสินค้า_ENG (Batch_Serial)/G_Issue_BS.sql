...
SELECT DISTINCT
    ...
    IGE1.ItemCode,
    OITM.FrgnName,
    ISNULL(NULLIF(OUOM.U_SLD_Uomforeign,''), IGE1.UomCode) AS 'UomCode',
    IGE1.Quantity,
    IGE1.WhsCode,
    OIGE.Comments,
    IGE1.unitmsr,
...
LEFT JOIN OUOM ON IGE1.UomCode = OUOM.UomCode
OUTER APPLY (
...
SELECT DISTINCT
    ...
    NULL AS 'LineNum',
    NULL AS 'ItemCode',
    NULL AS 'FrgnName', -- แก้ไขตรงนี้: เปลี่ยน OITM.FrgnName เป็น NULL AS 'FrgnName'
    NULL AS 'UomCode',
    NULL AS 'Quantity',
    NULL AS 'WhsCode',
    OIGE.Comments,
