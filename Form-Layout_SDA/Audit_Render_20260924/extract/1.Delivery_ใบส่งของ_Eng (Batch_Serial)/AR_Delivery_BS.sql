...
-- RPT: 2. Sales - AR\3. Delivery\2.Delivery_ใบส่งของ_(Batch_Serial)\1.Delivery_ใบส่งของ_Eng (Batch_Serial).rpt
-- SCOPE: main
...
NULL AS 'UgpCode', -- เปลี่ยนบรรทัดนี้เป็น NULL สำหรับ Text Row
