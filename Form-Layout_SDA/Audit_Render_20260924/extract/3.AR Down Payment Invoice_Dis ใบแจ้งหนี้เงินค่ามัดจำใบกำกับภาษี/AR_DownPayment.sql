-- ============================================================
-- Report: 3.AR Down Payment Invoice_Dis ใบแจ้งหนี้เงินค่ามัดจำใบกำกับภาษี.rpt
-- Path:   3.AR Down Payment Invoice_Dis ใบแจ้งหนี้เงินค่ามัดจำใบกำกับภาษี.rpt
-- Extracted: 2026-09-24 10:20:49
-- Source: Main Report
-- Table:  AR_DownPayment
-- ============================================================

-- RPT: 2. Sales - AR\5. AR Down Payment Invoice\1.AR Down Payment_ใบเสร็จรับเงินมัดจำ\1.AR Down Payment_ปกติ ใบเสร็จรับเงินมัดจำ.rpt
-- SCOPE: main
