...
LEFT JOIN (
    ...
    AND SRI.Direction = 1 -- เพิ่มเงื่อนไขนี้: กรองเฉพาะขาออก ป้องกันยอดเบิ้ล/แยกบรรทัด
...
LEFT JOIN (
    ...
    AND IBT.Direction = 1 -- เพิ่มเงื่อนไขนี้: กรองเฉพาะขาออก ป้องกันยอดเบิ้ล/แยกบรรทัด
