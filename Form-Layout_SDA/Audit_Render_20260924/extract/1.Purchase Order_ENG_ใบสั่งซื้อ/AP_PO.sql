...
-- RPT: 3. Purchasing - AP\3. Purchase Order\1.Purchase Order_TH_ใบสั่งซื้อ\1.Purchase Order_ENG_ใบสั่งซื้อ.rpt
-- SCOPE: main
-- ALIAS: AP_PO
-- FIELDS: 78
-- ---------------------------------------------------------------
...
SELECT DISTINCT
    ...
    NULL AS 'U_SLD_Dis_Amount',
        ...
        NULL AS 'Dscription_Frgn', -- text branch has no OITM join
